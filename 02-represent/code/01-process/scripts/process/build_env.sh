...
psql -d geocycle -U geocycle -f /usr/local/Cellar/osmosis/0.45/libexec/script/pgsnapshot_schema_0.6.sql
psql -d geocycle -U geocycle -f /usr/local/Cellar/osmosis/0.45/libexec/script/pgsnapshot_schema_0.6_linestring.sql
